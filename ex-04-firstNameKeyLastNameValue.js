...
function firstNameKeyLastNameValue(name1, name2, name3) {
  var separatedName1 = name1.split(" ");
  var separatedName2 = name2.split(" ");
  var separatedName3 = name3.split(" ");
  var nameObjs = {};

  nameObjs[separatedName1[0]] = separatedName1[1];
  nameObjs[separatedName2[0]] = separatedName2[1];
  nameObjs[separatedName3[0]] = separatedName3[1];
