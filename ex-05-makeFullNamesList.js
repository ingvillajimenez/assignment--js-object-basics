...
function makeFullNamesList(arrayObj){
  var arrayString = [];
  for (i = 0; i < arrayObj.length; i++){
    if(arrayObj[i].gender === "male" ){
      arrayString[i] = "Mr. " + arrayObj[i].first + " " + arrayObj[i].last;
    }
    else{
      arrayString[i] = "Ms. " + arrayObj[i].first + " " + arrayObj[i].last;
    }
  }
